...
export function AppSidebar({
  ...
  return (
    <>
      {/* Outer wrapper: icon rail + sidebar panel */}
      <div className="flex h-svh">
        ...
        <Sidebar
          collapsible="none"
          className="w-72 shrink-0 border-r border-sidebar-border flex flex-col h-full"
          {...props}
        >
          {/* Header: tab title + new chat button */}
          ...
          <SidebarContent className="flex-1 overflow-y-auto px-2 py-2">
            ...
            {activeTab === "friends" && (
              <FriendsList onStartChat={onSelectChat} />
            )}
            ...
            {activeTab === "groups" && (
              <EmptyState
                ...
                description="Tạo nhóm để trò chuyện cùng nhiều người"
              />
            )}
