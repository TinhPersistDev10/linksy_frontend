...
export default function AddFriendModal({ open, onClose, onFriendAdded }: AddFriendModalProps) {
  ...
  const tabs: { id: Tab; label: string; icon: React.ElementType; count?: number }[] = [
    ...
    { id: 'received', label: 'Lời mời', icon: Bell, count: receivedRequests.length },
