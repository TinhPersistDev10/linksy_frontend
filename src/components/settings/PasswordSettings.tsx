  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Bảo vệ tài khoản bằng mật khẩu mạnh</p>
      </div>
      ...
      <div className="flex gap-3 p-4 bg-blue-50 border border-blue-100 rounded-lg">
        ...
        <div className="text-sm text-blue-700">
          ...
          <p className="mt-0.5 text-blue-600">Sử dụng ít nhất 8 ký tự kết hợp chữ hoa, số và ký tự đặc biệt</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        {newPassword && (
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-muted-foreground">Độ mạnh: <span className="font-medium">{strength.label}</span></p>
          </div>
        )}
