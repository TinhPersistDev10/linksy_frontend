...
import { LoginRequest, LoginResponse, RegisterRequest, RegisterResponse, VerifyEmailRequest, VerifyEmailResponse, ResendOtpRequest, User } from '../types/auth';
...
export const authApi = {
  ...
  resendOtp: async (data: ResendOtpRequest): Promise<{ success: boolean; message: string }> => {
